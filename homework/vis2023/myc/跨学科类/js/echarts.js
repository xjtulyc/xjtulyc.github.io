...
$(function () {
    ...
    function echarts_1() {
        ...
        var data = [
            ...
            {value: 75,name: '核科学院'},
            {value: 21,name: '农学院'},
            {value: 40,name: '国际数学研究中心'},
            {value: 36,name: '天体物理研究院'},
            {value: 61,name: '燕京学堂'},
            {value: 129,name: '人工智能研究院'},
        ];
        ...
        option = {
            ...
            color: ['#af89d6', '#4ac7f5', '#0089ff', '#f36f8a','#61c27a', '#f5b842', '#3d98c6', '#e9526b', ],
            legend: { //图例组件，颜色和名字
                x: '70%',
                y: 'center',
                orient: 'vertical',
                ...
                itemHeight: 10,
                icon: 'rect',
                data: ["元培学院", '叉院', '核科学院', '农学院', '国际数学研究中心','天体物理研究院','燕京学堂','人工智能研究院'],
                textStyle: {
                    color: [],
                    fontStyle: 'normal',
                    fontFamily: '微软雅黑',
    ...
    function echarts_2() {
        ...
        option = {
            ...
            legend: {
                x: 'center',
                y: '2%',
                data: ['在校留学生', '在校本科生','毕业本科生（可统计）', '在校研究生','毕业研究生（可统计）' ],
                icon: 'circle',
                textStyle: {
                    color: '#fff',
                }
            ...
            series : [
                {
                    ...
                    data:[19,45,53,15,94,100,78,60,21,55,36,21,72,0,0,35,0,83,0,12,26,39,26,14,0,95,12,57,78,0,0,22,18,40,56,55,39,110,40,68,23,34,0,120,38,77,46,30,86,63,42]
                }
            ]
        };
